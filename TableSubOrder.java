...
public class TableSubOrder extends JPanel {
    private boolean DEBUG = false;
    JTable table;
    MyTableModel tableModel=new MyTableModel();
    private String[] columnNames;

    public TableSubOrder() {
...
//        private String[] columnNames ;
        //public Object[][] data;
        public ArrayList<Row> data = new ArrayList<>();


        MyTableModel(){
            // column are hardcode here with
            columnNames=new String[] {"Count","Item","Price"};
        }
        @Override
        ...
        public void setValueAt(Object value, int row, int col) {
            ...
            switch (col) {
                ...
                case 2:
                    if (value instanceof String) {
                        oneItem.setItemPrice((String)value);
                    }
                    break;
            }
